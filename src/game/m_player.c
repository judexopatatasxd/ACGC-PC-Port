...
static int Player_actor_Set_Item_net_catch_request_table(ACTOR*, GAME*, mPlayer_net_catch_label_t, s8, const xyz_t*,
                                                         f32);
static f32 Player_actor_Get_Item_net_catch_swing_timer(ACTOR*, GAME*);
static int Player_actor_Set_Item_net_catch_request_force(ACTOR*, GAME*, mPlayer_net_catch_label_t, s8);
...
static mPlayer_net_catch_label_t Player_actor_Get_item_net_catch_label(ACTOR*);
static int Player_actor_Change_item_net_catch_label(ACTOR*, mPlayer_net_catch_label_t, s8);
